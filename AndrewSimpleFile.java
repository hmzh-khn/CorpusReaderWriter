...
public class AndrewSimpleFile extends File implements Iterable<String>
{
  ...
  static {
    try {
      BASEDIR = URLDecoder.decode(AndrewSimpleFile.class.getResource("AndrewSimpleFile.class").getPath().replaceAll("[^/]+$", ""), "UTF-8");
  ...
  /*************************************************************************
   * Construct a new AndrewSimpleFile from a filename.
   * 
   * A AndrewSimpleFile may be used for either reading or writing.
   * 
   * @param filename The filename of the file.
   */
  
  public AndrewSimpleFile(String filename)
  {
   ...
   * @param filename The filename of the file.
   */
  public AndrewSimpleFile(String parent, String filename)
  {
   ...
   * @param filename The filename of the file.
   */
  public AndrewSimpleFile(File parent, String filename)
  {
    super(parent, filename);
  }
  ...
  {
    if (inputReader != null) {
      throw new AndrewSimpleFileException("Cannot write to a file while reading it");
    }
    if (outputStream != null) {
      throw new AndrewSimpleFileException("You need to stop writing first");
    }
    try {
    ...
    {
      outputStream = null;
      throw new AndrewSimpleFileException("Failed to start writing: " + exception.getMessage());
    }
  }
  ...
  {
    if (outputStream == null) {
      throw new AndrewSimpleFileException("You need to start writing first");
    }  
    return outputStream;
  }
  ...
  {
    if (inputReader != null) {
      throw new AndrewSimpleFileException("You need to stop reading first");
    }
    if (outputStream != null) {
      throw new AndrewSimpleFileException("You cannot read a file while you are writing it");
    }
    try {
    ...
    {
      inputReader = null;
      throw new AndrewSimpleFileException("Failed to start reading: " + exception.getMessage());
    }
  }
  ...
  {
    if (inputReader == null) {
      throw new AndrewSimpleFileException("You need to start reading first");
    }
    if (line != null)
      return true;
    else
  ...
  public String readNextLine()
  {
    ...
    if (line == null) {
      throw new AndrewSimpleFileException("There are no more lines to read");
    }
    ...
    {
      throw new AndrewSimpleFileException("Failed while reading: " + exception.getMessage());
    }
    return nextLine;
  }
  ...
  public void stopReading()
  {
    if (inputReader != null) {
      ...
      {
        inputReader = null;
        throw new AndrewSimpleFileException("Error when trying to close file: " + exception.getMessage());
      }
    }
  }
...
//////////////////////////////////////////////////////////////////////////////////////////
  ...
  public class AndrewSimpleFileException extends RuntimeException
  {
    AndrewSimpleFileException(String message)
    {
      super(message + " with file " + AndrewSimpleFile.this.getName());
    }
  }
}